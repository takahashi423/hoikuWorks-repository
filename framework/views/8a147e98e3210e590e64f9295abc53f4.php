...
<body>
    ...
    <div class="position-relative">
        ...
        <div class="title position-absolute top-50 start-50 translate-middle text-center">
            <h1>作品投稿</h1>
            <form action="<?php echo e(route('create_post')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hoikuWorks\resources\views/works/create.blade.php ENDPATH**/ ?>